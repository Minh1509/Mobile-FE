...
import { addExpense } from "@/app/services/budget.service";
...
const ExpenseScreen = () => {
    ...
    const categoriesList = ["Tiền điện", "Thuê nhà", "Internet", "Di chuyển", "Giải trí", "Mua sắm", "Học tập", "Tiền nước", "Ăn uống", "Khác"];
    const [categories, setCategories] = useState<string[]>(categoriesList); // Sử dụng categoriesList
    ...
    const handleSave = async () => {
        try {
            ...
            const ExpenseData: Omit<ITransaction, 'id' | 'type' | 'createdAt' | 'updatedAt'> = {
                userId: userId,
                category: categoryName, // Lưu categoryName
                            ...
                            <ScrollView>
                                {categories.map((item, index) => (
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            setCategoryName(item); // Chỉ lưu tên danh mục
