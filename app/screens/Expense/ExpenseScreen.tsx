...
const ExpenseScreen = () => {
    ...
    const categories = ["Tiền điện", "Thuê nhà", "Internet", "Di chuyển", "Giải trí", "Mua sắm", "Học tập", "Tiền nước", "Ăn uống", "Khác"];
    ...
    const mapPaymentMethodToEnum = (method: string): PayMethod => {
        switch (method) {
            case "Tiền mặt": return PayMethod.CASH;
            case "Thẻ tín dụng": return PayMethod.CARD;
            case "Ví điện tử": return PayMethod.BANK_TRANSFER;
